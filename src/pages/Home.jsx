...
export default function Home() {
    ...
    return (
        <div className="space-y-24">
            {/* Hero Section */}
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-2 text-center">
                <motion.img
                ...
                />
                <motion.h1 
                    className="font-coiny text-5xl md:text-7xl font-black mb-2 bg-gradient-to-r from-[var(--color-pink)] via-[var(--color-orange)] to-[var(--color-yellow)] bg-clip-text text-transparent leading-tight pb-3"
                ...
                <motion.p 
                    className="text-xl md:text-2xl text-dark/80 dark:text-off-white/80 max-w-2xl mx-auto mb-3"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
