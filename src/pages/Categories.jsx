...
export default function CategoriesPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h1 className="text-5xl font-black text-center mb-4 bg-gradient-to-r from-[var(--color-yellow)] via-[var(--color-orange)] to-[var(--color-pink)] bg-clip-text text-transparent leading-tight pb-2">Categories</h1>
